const dict = {
    en: {
        ...
        create_swap_subline: "Payment Includes Network and ZEUS Fee",
        ...
        transaction_refunded: "ZEUS Swaps has refunded the Transaction",
        ...
        on: "on",
        off: "off",
        notification_header: "ZEUS Swaps",
        ...
        download_boltz_rescue_key: "Download ZEUS Swaps Rescue Key",
        ...
        download_boltz_rescue_key_subline_third:
            "To continue, please select if you want to download a new ZEUS Swaps Rescue Key or verify an existing one.",
    ...
    de: {
        ...
        transaction_refunded: "ZEUS Swaps hat die Transaktion erstattet.",
        ...
        download_boltz_rescue_key: "ZEUS Swaps Rettungsschlüssel herunterladen",
        download_boltz_rescue_key_subline:
            "Wir haben pro-Swap Rückerstattungsdateien mit einem einzigen ZEUS Swaps Rettungsschlüssel ersetzt 🙌",
        download_boltz_rescue_key_subline_second:
        ...
        download_boltz_rescue_key_subline_third:
            "Wähle bitte aus, ob du einen neuen ZEUS Swaps Rettungsschlüssel herunterladen oder einen existierenden Schlüssel verifizieren möchtest.",
        ...
        verify_boltz_rescue_key_subline:
            "Bitte wähle den zuvor heruntergeladenen ZEUS Swaps Rettungsschlüssel aus, um seine Gültigkeit zu überprüfen.",
    ...
    es: {
        ...
        create_swap_subline:
            "El pago incluye la comisión de red y servicio de ZEUS Swaps",
        ...
        transaction_refunded: "ZEUS Swaps ha reembolsado la transacción!",
        ...
        download_boltz_rescue_key: "Descargar clave de rescate ZEUS Swaps",
        download_boltz_rescue_key_subline:
        ...
        verify_boltz_rescue_key: "Verificar clave de rescate ZEUS Swaps",
        verify_boltz_rescue_key_subline:
            "Por favor, seleccione tu clave de rescate ZEUS Swaps previamente descargada para verificar su validez.",
    ...
    pt: {
        ...
        create_swap_subline:
            "O pagamento inclui a taxa da rede e a taxa da ZEUS Swaps",
        ...
        transaction_refunded: "A ZEUS Swaps reembolsou a transação",
        ...
        download_boltz_rescue_key: "Baixar chave de resgate da ZEUS Swaps",
        download_boltz_rescue_key_subline:
    ...
    zh: {
        ...
        create_swap: "创建原子交换",
        create_swap_subline: "付款包括网络和ZEUS Swaps服务费",
        cancel_swap: "取消交换",
        new_swap: "新的交换",
        success_swap: "交换成功",
        ...
        transaction_refunded: "ZEUS Swaps已退款交易!",
        refunded: "交换已退还",
        broadcasted: "退款已广播",
    ...
    ja: {
        ...
        create_swap_subline:
            "支払いにはネットワーク手数料とZEUS Swapsサービス手数料が含まれます",
        ...
        transaction_refunded: "ZEUS Swapsがトランザクションを返金しました",
